...
import javax.swing.tree.DefaultMutableTreeNode;
    ...
    public class CustomarWindow extends javax.swing.JFrame {
        ...
        private void initComponents() {
            ...
            login.setForeground(new java.awt.Color(0, 3, 5, 255));
            login.setText("Login");
            ...
            shopProduct.setForeground(new java.awt.Color(0, 3, 5, 255));
            ...
            viewCart.setForeground(new java.awt.Color(0, 3, 5, 255));
            ...
            jPanel3.setBackground(new java.awt.Color(0, 3, 5, 255));
            ...
            addCart.setForeground(new java.awt.Color(0, 3, 5, 255));
        ...
        private void shopProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shopProductActionPerformed
            ...
            DefaultMutableTreeNode root = new DefaultMutableTreeNode("RM_Store");

            // Create The Child nods
            nameDepartment = new String[Department.nameDepartment.size()]; // The Size Depand For The Many Of Department
            ...
            for(int i = 0 ; i <  nameDepartment.length ; ++i){
                for(int j = 0 ; j < addNewProduct.countiner ; ++j){
                    if(departmentNode[i].toString().equals(addNewProduct.product[j].getDep())){
                        departmentNode[i].add(new DefaultMutableTreeNode(addNewProduct.product[j].getNameProduct()));
                    }
                }
            }
...
// ========================= Get The Object From Product Class When I Click In The Node
                    ...
                    for(int i = 0 ; i < addNewProduct.countiner ; ++i){
                        if(addNewProduct.product[i].getNameProduct().equals(labelProduct.getText())) {
